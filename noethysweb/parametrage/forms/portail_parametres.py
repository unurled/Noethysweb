...
LISTE_RUBRIQUES = [
    ...
    ("Page de connexion", ["connexion_image_fond", "connexion_adresse_exp", "connexion_question_perso", "connexion_afficher_nom_organisateur", "autoriser_inscription_famille"]),
