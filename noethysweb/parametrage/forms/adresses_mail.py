...
class Formulaire(FormulaireBase, ModelForm):
    cle_api = forms.CharField(label="Clé API", required=False, help_text="Saisissez la clé API associée à votre moteur.")
    cle_secrete = forms.CharField(label="Clé secrète", required=False, help_text="Saisissez la clé secrète associée à votre moteur.")
