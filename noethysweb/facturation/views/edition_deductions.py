...
from facturation.forms.edition_deductions import Formulaire
...
def Generer_pdf(request):
    ...
    # Création du PDF
    from facturation.utils import utils_impression_deductions
    impression = utils_impression_deductions.Impression(titre="Edition des déductions", dict_donnees=options)
...
class View(CustomView, TemplateView):
    menu_code = "edition_deductions"
    template_name = "facturation/edition_deductions.html"

    def get_context_data(self, **kwargs):
        context = super(View, self).get_context_data(**kwargs)
        context['page_titre'] = "Edition des déductions"
        context['box_titre'] = "Edition des déductions"
