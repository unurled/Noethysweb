...
LISTE_ONGLETS = [
    ...
    Onglet(code="individu_informations", label=_("Traitement, PAI et automédication"), icone="fa-heartbeat", url="portail_individu_informations", validation_auto=True),
    Onglet(code="individu_allergies", label=_("Allergies"), icone="fa-certificate", url="portail_individu_allergies", validation_auto=False),
    Onglet(code="individu_dispmed", label=_("Dispositifs médicaux"), icone="fa-eye", url="portail_individu_dispmed", validation_auto=False),
    Onglet(code="individu_maladies", label=_("Maladies"), icone="fa-stethoscope", url="portail_individu_maladies", validation_auto=False),
    Onglet(code="individu_traitement", label=_("Traitements effectués"), icone="fa-stethoscope", url="portail_individu_traitement", validation_auto=False),
