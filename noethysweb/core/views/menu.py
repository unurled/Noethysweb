...
def GetMenuPrincipal(organisateur=None, user=None):
    ...
    menu_modeles.Add(code="modeles_documents_liste", titre="Modèles de documents à transmettre", icone="file-text-o")
    ...
    menu_pieces_individus.Add(code="types_pieces_liste", titre="Paramétrage des documents à envoyer par les parents", icone="file-text-o")

    #Pièces à diffuser
    menu_pieces_individus = menu_individus.Add(titre="Pièces à diffuser aux familles")
    menu_pieces_individus.Add(code="portail_documents_liste", titre="Paramétrage", icone="file-text-o")
    ...
    menu_infos_sondages.Add(code="sondages_liste", titre="Paramétrage", icone="file-text-o")

    menu_infos_articles = menu_individus.Add(titre="Articles en page d'accueil")
    menu_infos_articles.Add(code="articles_liste", titre="Articles", icone="file-text-o")
    menu_infos_articles.Add(code="albums_liste", titre="Albums photos", icone="file-text-o")
    menu_infos_articles.Add(code="images_articles_liste", titre="Banque d'images des articles", icone="file-text-o")
    ...
    # Photos
    menu_photos_individus = menu_individus.Add(titre="Photos des individus")
    ...
    # Assistant sanitaire
    menu_as = menu_individus.Add(titre="Assistant sanitaire")
    menu_as.Add(code="traitement_liste", titre="Liste des traitements sanitaires", icone="file-text-o")
