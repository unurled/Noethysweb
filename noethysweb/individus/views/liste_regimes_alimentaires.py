...
class Liste(Page, crud.Liste):
    ...
    def get_queryset(self):
        ...
        return Individu.objects.prefetch_related("regimes_alimentaires").filter(idindividu__in=individus_inscrits).filter(self.Get_filtres("Q"))
    ...
    class datatable_class(MyDatatable):
        filtres = ["idindividu", "ipresent:pk", "iscolarise:pk", "nom", "prenom", "regimes_alimentaires__nom"]
